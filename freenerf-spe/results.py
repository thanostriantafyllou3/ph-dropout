...
def results(args):
    ...
    if os.path.exists(args.model_dir + "/point_cloud") and os.path.exists(args.model_dir + "/train") and os.path.exists(args.model_dir + "/test"):
        ...
        avg_train_ssim_no_dropout = torch.mean(compute_ssims(gt_train_images, train_images_one_sample_no_dropout)).item()
        avg_train_ssim = torch.mean(compute_ssims(gt_train_images, train_images_one_sample)).item()
